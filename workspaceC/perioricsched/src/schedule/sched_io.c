...
void create_xml(char *file, int num_tasks, long *set_periods, long *set_wcets) {
...
void write_xml(char *file, int num_tasks, long *periods, long *wcets, long *offsets) {
